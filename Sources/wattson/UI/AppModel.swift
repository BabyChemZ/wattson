...
final class AppModel: ObservableObject {
    ...
    static func preview() -> AppModel {
        ...
        state.rows = [
                ProcessRow(pid: 1, command: "verge-mihomo",
                           ...
                           detail: L("network throughput collapsed to 0% of normal",
                                     "网络吞吐跌到正常水平的 0%")),
                ProcessRow(pid: 2, command: "Codex (Service)",
                ...
                ProcessRow(pid: 4, command: "Obsidian",
                ...
                ProcessRow(pid: 5, command: "WindowServer",
                ...
                ProcessRow(pid: 6, command: "tailscaled",
